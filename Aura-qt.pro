...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/Aura-Qt.rc

win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/Aura-Qt.rc
...
macx:ICON = src/qt/res/icons/Aura.icns
macx:TARGET = "Aura-Qt"
...
linux:LIBS += -lboost_system-mt
linux:LIBS += -lboost_filesystem-mt
linux:LIBS += -lboost_program_options-mt
LIBS += -lboost_thread$$BOOST_THREAD_LIB_SUFFIX
macx:LIBS += -lboost_system$$BOOST_LIB_SUFFIX
macx:LIBS += -lboost_filesystem$$BOOST_LIB_SUFFIX
macx:LIBS += -lboost_program_options$$BOOST_LIB_SUFFIX
...
win32:LIBS += -lws2_32 -lshlwapi -lmswsock -lole32 -loleaut32 -luuid -lgdi32 -pthread

contains(RELEASE, 1) {
    linux {
        # Linux: turn dynamic linking back on for c/c++ runtime libraries
        LIBS += -Wl,-Bdynamic
        binfile.files += release/Aura-qt
        binfile.path = /usr/bin
        icon.files += src/qt/res/icons/Aura_64x64.png
        icon.path = /usr/share/Aura-qt/
        shortcut.files += share/linux/Aura-qt.desktop
